        ...
        {isSidebarOpen && (
          ...
          >
            <div className="flex items-center justify-between mb-12 px-2">
              <Link to="/app" className="flex items-center gap-2">
                <motion.div 
                  ...
                  className="p-1.5 bg-emerald-600 rounded"
                >
              ...
              <motion.button 
                whileHover={{ scale: 1.1, backgroundColor: 'rgba(6, 78, 59, 1)' }}
                whileTap={{ scale: 0.9 }}
            ...
            <motion.div 
              ...
              className="pt-8 border-t border-emerald-800"
            >
              ...
              {isNotifOpen && (
                <>
                  ...
                  <motion.div 
                    ...
                    className="absolute right-0 top-14 w-80 sm:w-96 bg-white rounded-[2rem] shadow-4xl border border-emerald-50 z-50 p-6"
                  >
                         ...
                         <motion.div 
                           ...
                           className={`p-4 rounded-2xl border transition-all cursor-pointer group relative ${
                             notif.isRead 
                               ...
                               : 'bg-beige/40 border-emerald-100/50 hover:bg-white hover:border-emerald-200 shadow-sm'
                           }`}
                         >
                  ...
                  {isAccountOpen && (
                    <>
                      ...
                      <motion.div 
                        ...
                        exit={{ opacity: 0, y: 10, scale: 0.95 }}
                        transition={{ type: 'spring', damping: 20, stiffness: 300 }}
                        className="absolute right-0 top-14 w-64 bg-white rounded-[2rem] shadow-4xl border border-emerald-50 z-50 p-6"
                      >
                        <div className="text-center mb-6">
                           <motion.div 
                             whileHover={{ rotate: 5, scale: 1.05 }}
                             className="w-16 h-16 rounded-2xl premium-gradient flex items-center justify-center text-white text-2xl font-black mx-auto mb-3 shadow-xl shadow-emerald-100"
                           >
                              {user.name.charAt(0)}
                           </motion.div>
